👋 Hi, I’m @Mithua [Soutrik Banerjee]  
👀 This is my first profile, the other being https://github.com/soutrikbanerjee/  
...
🌱 I’m currently learning `Java, Julia`, the latter is both an OOP & functional, line-interpreted & compiled language that has similarities in syntaxes with Matlab, `R, Python, Scala, Mathematica` among others. It is supposed to be very fast (C), with the ease of `Python`, & has the scientific prowess of `R`.  
